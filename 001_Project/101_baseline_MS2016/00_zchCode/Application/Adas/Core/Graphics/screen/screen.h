...
enum {
	...
	*/
	...
	/** The pixmap that contains the brush to be used when the window
	*  sensitivity mask has a brush bit set and the corresponding type of24
	*  input event is delivered to the window. The pixmap can use an rgb
	*  color format for color information. The alpha channel can be used to
	*  define the brush shape. The pixmap buffer size will determine the
	*  size of the brush. No drawing will occur if the window has a
	*  brush sensitivity bit set and no brush pixmap.829
	*/
