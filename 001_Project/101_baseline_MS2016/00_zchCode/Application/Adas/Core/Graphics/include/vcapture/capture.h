...
*   @defgroup capture_properties_threads Interface, threads, and offsets
*   @defgroup capture_properties_interface Interface type
...
*         driver may @c slog*() more detailed error information. Use @c sloginfo
*         to retrieve it.
*/
...
*                  there is no frame.
* @param flags  The flag specifying how to handled queued frames. Set to one of:
*               - 0 (zero) to retrieve all queued frames in sequence.
*               - @c #CAPTURE_FLAG_LATEST_FRAME to retrieve the latest frame,
*                 discarding all the other queued frames.
*
...
*/
/**
* @brief The video capture API includes constants, data types, enumerated values,
*        and macros specifying video capture properties.
*
* @details @c CAPTURE_PROPERTY() converts string constants into ingeters. This
...
/*
    ...
    CAPTURE_FLAG_COLOR_SPACE_FULL    - If color space is RGB use 0..255 extended RGB range. If color space is YUV use
                                       ...
                                       use full range of 0..1024/0..4096.
...
/**
*   @addtogroup capture_source_buffer
*   @{
*/
/**
...
/** @} */   /* end of addtogroup capture_source_buffer */
...
/**
* @brief  Frame or field is shorter than expected. One of the reasons could be wrong
*         selection of analog broadcast standard, hardware expects PAL 576i signal
*         while NTSC 480i is used instead. May contain incomplete frame.
*         if frame or field is shorter due to errors in transmission the flag
*         #CAPTURE_FRAME_FLAG_ERROR is also set.
*/
...
/**
*   @addtogroup capture_properties_interface
*   @{
*/
/**
...
/** @} */   /* end of addtogroup capture_properties_interface */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/release/service-screen/branches/moonraker/trunk/lib/capture/public/vcapture/capture.h $ $Rev: 782319 $")
#endif
