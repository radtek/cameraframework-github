...
{   
    ...
    rtnv = ilm_layerCreateWithDimension(&ilmLayerId, width, height);
    if(rtnv != ILM_SUCCESS)
    {
        printf("layerCreateWithDimension Failed (%d)\n", rtnv);
        //return 1;
    }
    ...
    if(rtnv != ILM_SUCCESS)
    {
        printf("layerSetVisibility Failed (%d)\n", rtnv);
        //return 1;
    }
    ...
    if(rtnv != ILM_SUCCESS)
    {
        printf("displaySetRenderOrder Failed (%d)\n", rtnv);
        //return 1;
    }
    ...
    if(rtnv != ILM_SUCCESS)
    {
        printf("layerSetRenderOrder Failed (%d)\n", rtnv);
        //return 1;
    }
...
bool GlShell::InitView(int screenWidth, int screenHeight)
{
