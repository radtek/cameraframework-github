#ifndef __HARMAN_ADAS_AFRAMEWORK_AFOUNDATION_CFUNCTOR_H__
#define __HARMAN_ADAS_AFRAMEWORK_AFOUNDATION_CFUNCTOR_H__
...
#endif // __HARMAN_ADAS_AFRAMEWORK_AFOUNDATION_CFUNCTOR_H__